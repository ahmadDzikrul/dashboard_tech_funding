...
def update_graph_category(value_dropdown_category,radio_value):
    ...
    if value_dropdown_category == "Funding Amount VS Region":
        ...
        if radio_value == "Top 10":
            ...
            sumbu_x = 'Amount'
            sumbu_y = 'Region'
            fundXregion = fundXregion.sort_values(by="Amount", ascending = True)
        ...
        fig=px.bar(
            ...
            template = 'plotly_dark',width=lebar, height=tinggi)
        ...
        if radio_value == "Top 10":
            ...
            sumbu_x = 'Amount'
            sumbu_y = 'Vertical'
            fundXvertical = fundXvertical.sort_values(by="Amount", ascending = True)
        fig=px.bar(
